  ...
  return (
    <section>
      <header className="z-[999] relative">
        <motion.div
          className={clsx(
            "fixed top-20 left-1/2 -translate-x-1/2 h-[3.25rem] rounded-full border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] w-[23rem] items-center dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75",
            {
              "!w-[5rem]":
        ...
        ></motion.div>
        <nav className="flex fixed left-1/2 top-[5.2rem] -translate-x-1/2 py-0 h-[initial]">
