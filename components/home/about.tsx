...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        I'm currently a student in Higher School preparing for bachelor degree
        in <span className="font-medium">Mechatronics Engineer</span>, I decided to
        pursue my passion for programming. I enrolled in a coding Udemy bootcamp
        and learned{" "}
      ...
      <p>
        ...
        learning about{" "}
        <span className="font-medium">
          designing with Figma and also about Electronics
        </span>
        . I'm also learning how to create contents.
      </p>
      <div className="flex items-center justify-center mt-12">
        <div className="relative">
          ...
          <button className="relative rounded-lg bg-gray-950 px-4 py-2 text-white">
            <a
              href="https://iayvoblog.vercel.app"
              className="flex items-center gap-3"
            >
              iayvoblog <FiExternalLink />
            </a>
          </button>
        </div>
      </div>
