...
export default function CardInfo({ title, description, tags, imageUrl, link }: Props) {
    ...
    return <motion.div className=" group mb-3 sm:mb-8 last:mb-0"  style={{ scale: scaleProgress, opacity: opacityProgress, }} ref={ref} >
